...
INPUT_DIR = os.path.join(
    PROJECT_ROOT, "data", "ultrasound", "standardized", "mmotu"
)
OUTPUT_DIR = os.path.join(
    PROJECT_ROOT, "data", "ultrasound", "processed", "mmotu"
)
...
# MAIN LOOP
# ----------------------------
print("🔄 Preprocessing MMOTU ultrasound images...")
